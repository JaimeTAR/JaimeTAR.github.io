  ...
  return (
    <section className="bg-neutral-800 py-8">
      <div className="max-w-[1080px] mx-auto text-center">
        ...
        {!selectedProject ? (
          <div className="flex justify-evenly text-left mb-4 flex-wrap">
          ...
          <div className="p-6 h-fit w-full mb-8 bg-stone-950 rounded-md shadow-lg shadow-black flex gap-4">
            <div className="text-start w-4/10">
              <button
              ...
              <div
                className="max-w-full mx-auto bg-center bg-contain bg-no-repeat rounded-4xl h-80 "
              ...
              <div className="flex justify-center gap-3 text-center mt-6 flex-wrap">
                {selectedProject.tech.map((language) => (
                  <div key={selectedProject.title + "_" + language + "_full"} className="relative inline-block">
                    <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 via-green-500 to-teal-500 rounded-md" />
                    <p className="text-lg relative bg-stone-950 text-blck px-2 py-1 rounded-md m-[1px]">{language}</p>
                  </div>
                ))}
              </div>
            </div>
